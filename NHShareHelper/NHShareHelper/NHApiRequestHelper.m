...
//获取token
//    [netHelper GET:BKWXGetTokenUrl Parameters:parameters Success:^(id responseObject) {
//        //获取token失败时
//        if (responseObject[@"errcode"]) {
//            [MBProgressHUD hideHUDForView:kWindow];
//            [MBProgressHUD showAutoMessage:@"授权失败，请重试" ToView:kWindow];
//            return;
//        }
//
...
//        dispatch_queue_t queue = dispatch_queue_create(NULL,DISPATCH_QUEUE_PRIORITY_DEFAULT);
//        dispatch_async(queue, ^{
//            kSetLocalUserinfos(_open_id, kLocal_key_openid);
//            kSetLocalUserinfos(_access_token, kLocal_key_access_token);
//            kSetLocalUserinfos(_refresh_token, kLocal_key_refresh_token);
//            kLocalSynchronize;
//        });
