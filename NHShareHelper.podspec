...
s.subspec 'QQ' do |ss|
	...
	ss.source_files   = 'NHShareHelper/QQ/*.{h,m,md}'
...
s.subspec 'Wechat' do |ss|
	ss.dependency 'NHShareHelper/Gener'
	ss.source_files   = 'NHShareHelper/Wechat/*.{h,m,md}', 'NHShareHelper/Wechat/WeChatSDK/*.{h,txt}'
...
s.subspec 'WeiBo' do |ss|
	...
	ss.dependency 'NHShareHelper/Gener'
	ss.source_files   = 'NHShareHelper/WeiBo/*.{h,m,md}', 'NHShareHelper/WeiBo/WeiboSDK/*.{h}'
...
# 	ss.source_files   = 'NHShareHelper/AliOpen/*.{h,m}', 'NHShareHelper/AliOpen/**'
# 	ss.ios.frameworks = 'Security', 'SystemConfiguration','CoreGraphics','CoreTelephony'
# 	ss.ios.libraries  = 'iconv','stdc++', 'z', 'sqlite3'
...
# 	ss.source_files   = 'NHShareHelper/AliPay/*.{h,m}', 'NHShareHelper/AliPay/**'
# 	ss.ios.frameworks = 'Security', 'SystemConfiguration','CoreGraphics','CoreTelephony'
# 	ss.ios.libraries  = 'iconv','stdc++', 'z', 'sqlite3'
...
# 	ss.source_files   = 'NHShareHelper/Facebook/*.{h,m}', 'NHShareHelper/Facebook/**'
# 	ss.ios.frameworks = 'Security', 'SystemConfiguration','CoreGraphics','CoreTelephony'
# 	ss.ios.libraries  = 'iconv','stdc++', 'z', 'sqlite3'
